...
namespace Soccer.Shared.Migrations
{
    ...
    [Migration("20220905131802_changedrelationshipmethodology")]
    partial class changedrelationshipmethodology
    {
            ...
            modelBuilder.Entity("Soccer.Shared.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 9, 5, 15, 18, 2, 149, DateTimeKind.Local).AddTicks(7681));
            ...
            modelBuilder.Entity("Soccer.Shared.Entities.Team", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 9, 5, 15, 18, 2, 149, DateTimeKind.Local).AddTicks(9603));
